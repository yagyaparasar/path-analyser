...
export const ALGORITHMS = {
  dijkstra: {
    ...
    spaceComplexity: 'O(V)',
    bestUseCase: 'Finding shortest paths in graphs with non-negative weights, such as road networks or network routing.',
    avoidWhen: 'Graph contains negative edge weights, as it may produce incorrect results.',
    realWorldExample: 'GPS navigation systems use Dijkstra\'s algorithm to find the fastest route between locations.',
  ...
  aStar: {
    ...
    complexity: 'O((V + E) log V)',
    spaceComplexity: 'O(V)',
    bestUseCase: 'Pathfinding in spatial graphs where geometric distance provides a good heuristic, like game maps or robotics.',
    avoidWhen: 'No good heuristic is available, or when you need to find paths to multiple targets simultaneously.',
    realWorldExample: 'Video game AI uses A* to navigate characters through complex environments efficiently.',
    requiresNonNegative: true,
  },
  bfs: {
    name: 'BFS',
    ...
    complexity: 'O(V + E)',
    spaceComplexity: 'O(V)',
    bestUseCase: 'Finding shortest paths in unweighted graphs or when all edges have equal cost.',
    avoidWhen: 'Graph has weighted edges with varying costs, as BFS only counts hops, not total weight.',
    realWorldExample: 'Social networks use BFS to find degrees of separation between users (e.g., "6 degrees of Kevin Bacon").',
  ...
  dfs: {
    ...
    complexity: 'O(V + E)',
    spaceComplexity: 'O(V)',
    bestUseCase: 'Exploring all possible paths, detecting cycles, or topological sorting. Not for shortest path finding.',
    avoidWhen: 'You need the shortest or optimal path, as DFS explores depth-first and may find longer paths.',
    realWorldExample: 'Web crawlers use DFS to explore website structures and index pages for search engines.',
    requiresNonNegative: false,
  },
  bellmanFord: {
    name: 'Bellman-Ford',
    ...
    complexity: 'O(V × E)',
    spaceComplexity: 'O(V)',
    bestUseCase: 'Graphs with negative edge weights or when you need to detect negative cycles.',
    avoidWhen: 'Graph has only non-negative weights (use Dijkstra instead for better performance).',
    realWorldExample: 'Financial systems use Bellman-Ford to detect arbitrage opportunities in currency exchange rates.',
    requiresNonNegative: false,
  },
};
